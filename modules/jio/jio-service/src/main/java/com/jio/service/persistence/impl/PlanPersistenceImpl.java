...
package com.jio.service.persistence.impl;

import com.jio.exception.NoSuchPlanException;
import com.jio.model.Plan;
import com.jio.model.PlanTable;
import com.jio.model.impl.PlanImpl;
import com.jio.model.impl.PlanModelImpl;
import com.jio.service.persistence.PlanPersistence;
import com.jio.service.persistence.PlanUtil;
import com.jio.service.persistence.impl.constants.JIOPersistenceConstants;
 ...
 * @generated
 */
@Component(service = {PlanPersistence.class, BasePersistence.class})
public class PlanPersistenceImpl
	 ...
	 */
	@Override
	public List<Plan> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<Plan> findByUuid(String uuid, int start, int end) {
	...
	public List<Plan> findByUuid(
		String uuid, int start, int end,
		OrderByComparator<Plan> orderByComparator, boolean useFinderCache) {
		...
		if (list == null) {
			...
			sb.append(_SQL_SELECT_PLAN_WHERE);
			...
			if (orderByComparator != null) {
				...
				sb.append(PlanModelImpl.ORDER_BY_JPQL);
			}
	...
	public Plan findByUuid_First(
			String uuid, OrderByComparator<Plan> orderByComparator)
		throws NoSuchPlanException {

		Plan plan = fetchByUuid_First(uuid, orderByComparator);
	...
	public Plan fetchByUuid_First(
		...
		List<Plan> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public Plan findByUuid_Last(
		...
		Plan plan = fetchByUuid_Last(uuid, orderByComparator);
	...
	public Plan fetchByUuid_Last(
		...
		List<Plan> list = findByUuid(uuid, count - 1, count, orderByComparator);
	...
	public Plan[] findByUuid_PrevAndNext(
			long planId, String uuid, OrderByComparator<Plan> orderByComparator)
		throws NoSuchPlanException {
		...
		try {
			...
			array[0] = getByUuid_PrevAndNext(
				session, plan, uuid, orderByComparator, true);

			array[1] = plan;

			array[2] = getByUuid_PrevAndNext(
				session, plan, uuid, orderByComparator, false);
	...
	protected Plan getByUuid_PrevAndNext(
		Session session, Plan plan, String uuid,
		OrderByComparator<Plan> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(plan)) {
	...
	public int countByUuid(String uuid) {
		...
		if (count == null) {
			...
			sb.append(_SQL_COUNT_PLAN_WHERE);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_2 = "plan.uuid = ?";

	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(plan.uuid IS NULL OR plan.uuid = '')";
	...
	public Plan findByUUID_G(String uuid, long groupId)
		...
		Plan plan = fetchByUUID_G(uuid, groupId);
	...
	public Plan fetchByUUID_G(
		...
		if (result instanceof Plan) {
			...
			if (!Objects.equals(uuid, plan.getUuid()) ||
	...
	public Plan removeByUUID_G(String uuid, long groupId)
		...
		Plan plan = findByUUID_G(uuid, groupId);
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 =
		"(plan.uuid IS NULL OR plan.uuid = '') AND ";
	 ...
	 */
	@Override
	public List<Plan> findByUuid_C(String uuid, long companyId) {
		return findByUuid_C(
	...
	public Plan findByUuid_C_First(
		...
		Plan plan = fetchByUuid_C_First(uuid, companyId, orderByComparator);
	...
	public Plan findByUuid_C_Last(
		...
		Plan plan = fetchByUuid_C_Last(uuid, companyId, orderByComparator);
	...
	public Plan[] findByUuid_C_PrevAndNext(
		...
		try {
			...
			array[0] = getByUuid_C_PrevAndNext(
				session, plan, uuid, companyId, orderByComparator, true);

			array[1] = plan;

			array[2] = getByUuid_C_PrevAndNext(
				session, plan, uuid, companyId, orderByComparator, false);
	...
	protected Plan getByUuid_C_PrevAndNext(
		Session session, Plan plan, String uuid, long companyId,
		OrderByComparator<Plan> orderByComparator, boolean previous) {
	...
	public void cacheResult(Plan plan) {
		...
		finderCache.putResult(
			...
			new Object[] {plan.getUuid(), plan.getGroupId()}, plan);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(PlanImpl.class);
	}
	...
	protected void cacheUniqueFindersCache(PlanModelImpl planModelImpl) {
		Object[] args = new Object[] {
			planModelImpl.getUuid(), planModelImpl.getGroupId()
		};

		finderCache.putResult(_finderPathCountByUUID_G, args, Long.valueOf(1));
		finderCache.putResult(_finderPathFetchByUUID_G, args, planModelImpl);
	}
	...
	public Plan updateImpl(Plan plan) {
		...
		if (Validator.isNull(plan.getUuid())) {
			String uuid = _portalUUID.generate();
		...
		entityCache.putResult(PlanImpl.class, planModelImpl, false, true);

		cacheUniqueFindersCache(planModelImpl);
	...
	@Override
	@Reference(
		target = JIOPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = JIOPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
	...
	private static final String _SQL_SELECT_PLAN_WHERE =
		"SELECT plan FROM Plan plan WHERE ";

	private static final String _SQL_COUNT_PLAN =
		"SELECT COUNT(plan) FROM Plan plan";

	private static final String _SQL_COUNT_PLAN_WHERE =
		"SELECT COUNT(plan) FROM Plan plan WHERE ";
