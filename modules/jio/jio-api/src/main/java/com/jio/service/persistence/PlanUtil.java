...
public class PlanUtil {
	 ...
	 */
	public static List<Plan> findByUuid(String uuid) {
	 ...
	 */
	public static List<Plan> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	public static List<Plan> findByUuid(
	 ...
	 */
	public static Plan findByUuid_First(
			String uuid, OrderByComparator<Plan> orderByComparator)
		throws com.jio.exception.NoSuchPlanException {
	 ...
	 */
	public static Plan fetchByUuid_First(
		String uuid, OrderByComparator<Plan> orderByComparator) {
	 ...
	 * @throws NoSuchPlanException if a matching plan could not be found
	 */
	public static Plan findByUuid_Last(
			String uuid, OrderByComparator<Plan> orderByComparator)
		throws com.jio.exception.NoSuchPlanException {
	 ...
	 */
	public static Plan fetchByUuid_Last(
		String uuid, OrderByComparator<Plan> orderByComparator) {
	 ...
	 * @throws NoSuchPlanException if a matching plan could not be found
	 */
	public static Plan findByUUID_G(String uuid, long groupId)
		throws com.jio.exception.NoSuchPlanException {
	 ...
	 */
	public static Plan fetchByUUID_G(String uuid, long groupId) {
	 ...
	 * @return the matching plan, or <code>null</code> if a matching plan could not be found
	 */
	public static Plan fetchByUUID_G(
	 ...
	 */
	public static Plan removeByUUID_G(String uuid, long groupId)
		throws com.jio.exception.NoSuchPlanException {
	 ...
	 * @return the matching plans
	 */
	public static List<Plan> findByUuid_C(String uuid, long companyId) {
	 ...
	 * @return the range of matching plans
	 */
	public static List<Plan> findByUuid_C(
	 ...
	 * @throws NoSuchPlanException if a matching plan could not be found
	 */
	public static Plan findByUuid_C_First(
	 ...
	 * @return the first matching plan, or <code>null</code> if a matching plan could not be found
	 */
	public static Plan fetchByUuid_C_First(
		String uuid, long companyId,
		OrderByComparator<Plan> orderByComparator) {
	 ...
	 * @throws NoSuchPlanException if a matching plan could not be found
	 */
	public static Plan findByUuid_C_Last(
			String uuid, long companyId,
			OrderByComparator<Plan> orderByComparator)
		throws com.jio.exception.NoSuchPlanException {
	 ...
	 * @return the last matching plan, or <code>null</code> if a matching plan could not be found
	 */
	public static Plan fetchByUuid_C_Last(
		String uuid, long companyId,
		OrderByComparator<Plan> orderByComparator) {
	 ...
	 * @throws NoSuchPlanException if a plan with the primary key could not be found
	 */
	public static Plan[] findByUuid_C_PrevAndNext(
			long planId, String uuid, long companyId,
			OrderByComparator<Plan> orderByComparator)
		throws com.jio.exception.NoSuchPlanException {

		return getPersistence().findByUuid_C_PrevAndNext(
			planId, uuid, companyId, orderByComparator);
	}
